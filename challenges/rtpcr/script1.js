...
function selectedRowToInput() {
  for (var i = 1; i < table.rows.length; i++) {
    table.rows[i].onclick = function () {
      ...
      document.getElementById("gender1").value = this.cells[6].innerHTML;
...
//         table.rows[rIndex].cells[1].innerHTML = aadhar;
...
// }
function check (id) {
    var checks = document.getElementById("id").checked = true;
    checks.style.display = id;
}
function myFunction() {
  var input, filter, table, table1,tr, td, i, txtValue;
